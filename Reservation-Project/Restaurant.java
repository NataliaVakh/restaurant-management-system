...
public class Restaurant {
    ...
    public Map<String, String[]> readLayout() {
    ...
    public void updateLayout(Map<String, String[]> layout) {
    ...
    public void addPartyToWaitlist(String name, int size, String contact) {
    ...
    public List<String[]> readWaitlist() {
    ...
    public void updateWaitlist(List<String[]> waitlist) {
    ...
    public List<String> viewWaitlist() {
        List<String[]> waitlist = readWaitlist();
    ...
    public List<String> viewOccupiedTables() {
        Map<String, String[]> layout = readLayout();
    ...
    //     // Seat a party when waitlist is empty
    //     r.seatParty();

    //     // Add parties to the waitlist
    //     System.out.println();
    //     r.addPartyToWaitlist("Alice", 2, "123456");
    //     r.addPartyToWaitlist("Bob", 4, "654321");
    ...
    //     System.out.println();
    //     Map<String, String[]> layout = r.readLayout();
    //     for (String tableNumber : layout.keySet()) {
    //         String[] tableDetails = layout.get(tableNumber);
    //         System.out.println("Table " + tableNumber + ": Seats " + tableDetails[0] + ", Occupied by " + tableDetails[1]);
    //     }
    // }
